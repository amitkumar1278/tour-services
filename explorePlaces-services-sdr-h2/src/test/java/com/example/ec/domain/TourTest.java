...
public class TourTest {
	...
	public void testConstructorAndGetters() throws Exception {
		...
		Tour tour = new Tour("title", "description", "blurb", 100, "3 day", "bullet", 
		...
		assertThat(tour.getPrice(), is(100));
		assertThat(tour.getDuration(), is("3 day"));
	...
	public void equalHashcodeVerify() {
		...
		TourPackage p = new TourPackage("CC", "name");
		Tour tour1 = new Tour("title", "description", "blurb", 100, "3 day", "bullet", 
				"keywords", p, Difficulty.Difficult, Region.Central_Coast);
		Tour tour2 = new Tour("title", "description", "blurb", 100, "3 day", "bullet", 
				"keywords", p, Difficulty.Difficult, Region.Central_Coast);
